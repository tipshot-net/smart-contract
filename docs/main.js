    ...
    (() => {
          ...
          Object.defineProperty(t, e, {
            ...
            get: function () {
              ...
              return (
                lt.target &&
                  (i.depend(),
                  u && (u.dep.depend(), Array.isArray(e) && jt(e))),
                e
              )
            },
            set: function (e) {
          ...
          if ((a(n) && (n = f.extend(n)), "function" == typeof n)) {
            ...
            if (o(n.options.functional))
              return (function (e, n, o, i, a) {
                ...
                var f = new Pe(o, c, a, i, e),
                  p = s.render.call(null, f._c, f)
                if (p instanceof vt) return Ie(p, o, f.parent, s)
                if (Array.isArray(p)) {
                  for (
            ...
            "string" == typeof e)
              ? ((c = (t.$vnode && t.$vnode.ns) || D.getTagNamespace(e)),
                (s = D.isReservedTag(e)
                  ...
                  : (n && n.pre) || !r((u = It(t.$options, "components", e)))
      ...
      function hn() {
        ...
        for (
          ...
          (t = an[fn]).before && t.before(), (e = t.id), (cn[e] = null), t.run()
        var n = sn.slice(),
          r = an.slice()
      ...
      function wn(t, e, n) {
        var r = !rt()
        "function" == typeof n
          ? ((gn.get = r ? xn(e) : $n(n)), (gn.set = j))
          : ((gn.get = n.get ? (r && !1 !== n.cache ? xn(e) : $n(n.get)) : j),
            (gn.set = n.set || j)),
        ...
        e.prototype._init = function (e) {
          ...
          ;(n._uid = kn++),
            ...
            e && e._isComponent
              ...
              : (n.$options = Pt(An(n.constructor), e || {}, n)),
            (n._renderProxy = n),
            (n._self = n),
            (function (t) {
              var e = t.$options,
      ...
      !(function (t) {
        ...
        Object.defineProperty(Sn, "FunctionalRenderContext", { value: Pe }),
        (Sn.version = "2.6.14")
        ...
        var n = (function (t) {
          if (
            ...
            return (Cr = t.lastIndexOf(".")) > -1
              ...
              : { exp: t, key: null }
          for (xr = t, Cr = kr = Ar = 0; !Kr(); )
            Jr(($r = zr())) ? Gr($r) : 91 === $r && Wr($r)
      ...
      var lo,
        ...
        vo = function (t, e, n) {
          if (fo.test(e)) t.style.setProperty(e, n)
            ...
            t.style.setProperty(C(e), n.replace(po, ""), "important")
          else {
            var r = mo(e)
            if (Array.isArray(n))
      ...
      function xo(t) {
        if (t) {
          if ("object" == typeof t) {
            var e = {}
            return !1 !== t.css && S(e, $o(t.name || "v")), S(e, t), e
          }
      ...
      Co &&
        ...
        void 0 === window.onanimationend &&
          ...
          ((jo = "WebkitAnimation"), (To = "webkitAnimationEnd")))
      var Eo = z
      ...
      function Io(t, e) {
        ...
        return (
                ...
                : 0),
          {
            ...
            timeout: l,
            propCount: f,
            hasTransform: n === ko && Po.test(r[So + "Property"]),
          }
        )
      }
      function Do(t, e) {
          ...
          if (!S || w || "" === w) {
            var O = S && d ? d : u,
              ...
              F = (o._enterCb = L(function () {
                I && (Lo(o, T), Lo(o, j)),
                  F.cancelled ? (I && Lo(o, O), N && N(o)) : M && M(o),
                  (o._enterCb = null)
              }))
            t.data.show ||
              ...
              I &&
                ...
                Ro(function () {
                  Lo(o, O),
                    F.cancelled ||
                      (Mo(o, T), D || (Ho(P) ? setTimeout(F, P) : No(o, c, F)))
                })),
                    ...
                    (function (t, n, o, i, a) {
                      for (
                        ...
                        e(h)
                          ...
                          ? (m = n[--v])
                          : sr(h, g)
                          ? (C(h, g, i, o, d), (h = n[++p]), (g = o[++d]))
                          : sr(m, b)
                          ? (C(m, b, i, o, y), (m = n[--v]), (b = o[--y]))
                          : sr(h, b)
                          ? (C(h, b, i, o, y),
        ...
        return function (t, n, i, a) {
          if (!e(n)) {
            ...
            if (e(t)) (l = !0), f(n, p)
              ...
              var d = r(t.nodeType)
              if (!d && sr(t, n)) C(t, n, p, null, null, a)
              else {
                if (d) {
                  if (
                    (1 === t.nodeType &&
      ...
      var mi,
        ...
        $i = d("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source"),
        Ci = d(
      ...
      function ja(t) {
        if (
          ...
          for (var e = 0, n = t.children.length; e < n; e++) {
            var r = t.children[e]
            ja(r), r.static || (t.static = !1)
          }
          if (t.ifConditions)
            for (var o = 1, i = t.ifConditions.length; o < i; o++) {
              var a = t.ifConditions[o].block
              ja(a), a.static || (t.static = !1)
            }
        }
      }
      function Ta(t, e) {
        if (1 === t.type) {
          ...
          if (((t.staticRoot = !1), t.children))
            for (var n = 0, r = t.children.length; n < r; n++)
              Ta(t.children[n], e || !!t.for)
          if (t.ifConditions)
            for (var o = 1, i = t.ifConditions.length; o < i; o++)
              Ta(t.ifConditions[o].block, e)
        }
      }
                ...
                (function (t, e) {
                  ...
                  function C() {
                    ...
                    if (e) {
                      ...
                      for (
                        $(e[0].length);
                        !(n = t.match(Ti)) && (r = t.match(Ai) || t.match(ki));
        ...
        render: function (t, e) {
          ...
          if (((i.routerViewDepth = l), f)) {
            var d = u[s],
              v = d && d.component
            return v
              ? (d.configProps && Ps(v, i, d.route, d.configProps), a(v, i, r))
              : a()
          }
          var h = c.matched[l],
            m = h && h.components[s]
          ...
          return (
            y && (ys(u[s], { route: c, configProps: y }), Ps(m, i, c, y)),
            a(m, i, r)
          )
        },
      }
      ...
      function nc(t, e, n, r) {
        ...
        var c = (function (t) {
          ...
          u = (e && e.path) || "/",
          l = c.path ? Is(c.path, u, n || o.append) : u,
          f = (function (t, e, n) {
            void 0 === e && (e = {})
            var r,
              o = n || Cs
        ...
        ic = {
          ...
          render: function (t) {
            var e = this,
              ...
              h = a.redirectedFrom ? Ss(null, nc(a.redirectedFrom), null, n) : a
        ...
        function s(t, n, r) {
          return t && t.redirect
            ? (function (t, n) {
                ...
                if (l) {
                  var v = (function (t, e) {
                    return Is(t, e.parent ? e.parent.path : "/", !0)
                  })(l, t)
                  return a(
      ...
      var jc,
        Tc =
          cc &&
          ((-1 === (jc = window.navigator.userAgent).indexOf("Android 2.") &&
            -1 === jc.indexOf("Android 4.0")) ||
            -1 === jc.indexOf("Mobile Safari") ||
            -1 !== jc.indexOf("Chrome") ||
            -1 !== jc.indexOf("Windows Phone")) &&
          window.history &&
          ...
          (e.prototype.setupListeners = function () {
            ...
            if (!(this.listeners.length > 0)) {
              ...
              var o = function () {
                var n = t.current,
                  o = Wc(t.base)
                ;(t.current === js && o === t._startLocation) ||
              ...
              var r = function () {
                  ...
                  Zc() &&
                    t.transitionTo(Xc(), function (r) {
                      n && wc(t.router, r, e, !0), Tc || tu(r.fullPath)
                    })
                },
                o = Tc ? "popstate" : "hashchange"
      ...
      function Qc(t) {
        Tc ? Ec(Yc(t)) : (window.location.hash = t)
      }
      function tu(t) {
        Tc ? Rc(Yc(t)) : window.location.replace(Yc(t))
      }
      var eu = (function (t) {
          function e(e, n) {
        ...
        nu = function (t) {
          ...
          var e = t.mode || "hash"
          switch (
            ((this.fallback = "history" === e && !Tc && !1 !== t.fallback),
      ...
      var Eu = su(
        {
          components: { Branch: Tu.exports, FooterBar: vu },
          props: { json: { type: Object, default: () => new Object() } },
          computed: {
            trees: function () {
              let t = {}
      ...
      Eu.options.__file = "node_modules/hardhat-docgen/src/components/Index.vue"
      const Ru = Eu.exports
      ms.use(iu)
      const Mu = {}
      new ms({
