...
import type { Miner, MinerInterface } from "../Miner";
...
export class Miner__factory {
  static readonly abi = _abi;
  static createInterface(): MinerInterface {
    return new utils.Interface(_abi) as MinerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Miner {
    return new Contract(address, _abi, signerOrProvider) as Miner;
  }
}
